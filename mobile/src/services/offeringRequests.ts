...
export const ANIMAL_REQUESTS: Record<AnimalType, AnimalRequestDef> = {
  ...
  pangolin: {
    ...
    requestLine: 'Bring me a word I can cook with. Something with a bit of substance. The table wants setting, and nobody will tell me who for.',
    fulfillTemplate: 'You gave me {word}. Into the pot it goes. Something in the steam leaned closer to smell it.',
  },
  owl: {
    theme: 'knowledge',
    ...
    fulfillTemplate: 'You found {word}. It fits the gap in the text exactly. Too exactly, perhaps. Another page has gone legible overnight.',
  },
  axolotl: {
    theme: 'water',
    words: ['TIDE', 'POOL', 'DEEP', 'WAVE', 'FLOW', 'MIST', 'RAIN', 'WELL', 'DROWN', 'DAMP', 'FLOOD', 'BRINE'],
    requestLine: 'Bring me a wet word, a deep one! The water shows me more when somebody feeds it.',
  ...
  capybara: {
    ...
    requestLine: 'Bring me a word about ORDER, when one turns up. Something keeps filing things in my ledger for me. One entry I chose myself would help.',
    fulfillTemplate: 'You logged {word}. I filed it myself, in my own hand, and it stayed where I put it. Noted, with thanks.',
  },
  fennec_fox: {
    theme: 'sound',
    words: ['ECHO', 'HUSH', 'TONE', 'CALL', 'WAIL', 'DRONE', 'PEAL', 'RING', 'HUM', 'MOAN', 'KNELL', 'CHIME'],
    requestLine: 'Bring me a word that makes a SOUND. I need something to check my ears against.',
    fulfillTemplate: 'You sent me {word}. I heard it go down, clean and small, and something below answered it. So my ears are working. I almost wish they were not.',
  },
  sloth: {
    theme: 'stillness',
    ...
    fulfillTemplate: 'You brought me {word}. Funny. I seem to have been holding that one for years. Thank you.',
  },
  wombat: {
    theme: 'earth',
  ...
  rabbit: {
    ...
    requestLine: 'I... I need to know this is more than my nerves. Bring me a word that feels AFRAID.',
    fulfillTemplate: 'You brought me {word}. So you feel it too. Not only my nerves, then. Almost a comfort.',
  },
  red_panda: {
    theme: 'emptiness',
    words: ['VOID', 'HUSH', 'REST', 'STILL', 'CALM', 'EMPTY', 'BLANK', 'HOLLOW', 'PEACE', 'MUTE', 'NULL', 'ZERO'],
    requestLine: 'Bring me something EMPTY, whenever one comes. I keep finding peace in hollow places, and I would like to know why.',
    fulfillTemplate: 'You brought me {word}. I sat with it a long while. It felt like rest. Whether it was rest is a separate question.',
  },
  tarsier: {
    theme: 'night',
