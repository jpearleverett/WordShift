...
const TRIGGER_WORD_REACTIONS: Record<AnimalType, Record<number, Record<string, string>>> = {
  fox: {
    ...
    4: {
      ...
      BURN: "BURN! Yes, exactly, let it all burn down to the lovely truth underneath! The fire accepts your offering, friend, and it asked me to tell you it has been saving you a seat.",
  ...
  pangolin: {
    ...
    2: {
      ...
      SPICE: "SPICE went through my kitchen like a flash of heat off a dry pan, and it did not come from the stove. It came from the meaning itself. My eyes watered the way they do over good peppers. I am choosing to take that as a compliment.",
  ...
  axolotl: {
    ...
    4: {
      ...
      FLOAT: "FLOAT, and we all float in the arrangement now, weightless, held, free the way a bubble is free, going exactly where it was always going and delighted about it, and oh, I am delighted about it.",
...
export const WORD_THRESHOLD_DIALOGUES: { threshold: number; phase: number; lines: Record<string, string> }[] = [
  ...
  },
  {
    ...
    lines: {
      ...
      owl: "Five hundred. The old texts predicted this number specifically, in the chapter I once refused to finish. They call it the threshold of no return. I have read past it now, in the book and, it would appear, in life.",
