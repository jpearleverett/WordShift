...
const TRIGGER_WORD_REACTIONS: Record<AnimalType, Record<number, Record<string, string>>> = {
  fox: {
    1: {
      ...
      FIRE: "The hearth crackled the exact moment you finished that word, and I mean the exact moment, I checked! Funny timing, isn't it. The fire and I've agreed to call it a coincidence for now.",
      EMBER: "Did you hear that? Something in the room said my name, or the flames did, or both at once! You must have spelled something wonderful, friend. I've been grinning about it ever since.",
      ...
      WARM: "The den grew warmer while you were working your words, just a little, just enough for me to notice. I told the fire it was showing off. It didn't deny it!",
    ...
    2: {
      ...
      FIRE: "The hearth surged the very moment you formed that word, like you'd fed it kindling made of letters. I've decided to find that charming. Sit with me and help me keep deciding it.",
      EMBER: "You spelled my name into the letters, didn't you! I felt it right here in my chest, warm as a coal. The fire felt it too. We're both a little giddy and a little something else.",
      BURN: "That word carries its own heat, friend, I promise you. It's still hanging in the air between us like the smell of toast. Cozy. Mostly cozy.",
      WARM: "Warmth where there should be a chill! Your words carry temperature now, which is a marvelous trick. The fire has noticed. So have I, and I'm choosing to be delighted about it.",
    ...
    3: {
      FLAME: "Friend, the fire wrote your word in sparks above the hearth. Drew it right there in the air! It's still glowing if you squint. I've been squinting all evening and telling myself it's lovely.",
      FIRE: "Fire leapt clean out of the hearth when you brought that word, reaching like a paw reaching for a gift. I clapped. I don't entirely know why I clapped.",
      ...
      BURN: "There are scorch marks in the air where you spelled that one, faint little letters of soot. I can still see them if I tilt my head. I've been tilting my head rather a lot lately.",
      ...
      _default: "The flames jump higher for your words now, higher every time. Hungry is what I'd call it if I were being honest. Grateful is what I call it instead, because that's nicer for both of us.",
    },
    4: {
  ...
  owl: {
    1: {
      BOOK: "A page turned in the study just now, entirely on its own. I wasn't reading. I have witnesses, or at least a teapot. You were arranging letters at the time, I believe, and I intend to record the coincidence before it stops being one.",
      READ: "The text on my desk blurred and reassembled itself while you worked, as though revised by an editor I haven't met. I have proofread the passage twice since. It's better now, which troubles me rather more than an error would.",
      KNOW: "That word moved through the study like a stone dropped into still water, ring after ring across the shelves. I recognize the sensation from precisely one other occasion, and I'm still deciding whether to consult my notes on it.",
      ...
      WORD: "Words within words within words. The letters you moved said something to my oldest volumes, and I distinctly heard several of them answer. I'm recording this in the margin, where I keep the things I'm not yet ready to put in the body of the text.",
      _default: "Something in the study shifted when you finished those words. A book fell open to a page I had never seen, in a volume I thought I knew entirely. I've owned that book for eleven years. I counted.",
    },
    2: {
      BOOK: "The books rearranged themselves on the shelf overnight. Alphabetically at first, which I could forgive, and then by some other principle entirely, which I'm still trying to derive. Your word was the last thing spoken in this house before it happened.",
      READ: "I find I can't read anymore without hearing your words underneath the text, the way one hears the older writing beneath a palimpsest. Every sentence has your letters under it now. I've checked several unrelated books. All of them.",
      KNOW: "KNOW. The word sounded in every volume simultaneously, like a bell struck in a library of bells. My question, for the record, isn't what the books learned. It's what they already knew, and were waiting to be asked.",
      WISE: "Wisdom has a frequency, it turns out. I heard it when you formed that word, and it frightened me for the simple reason that I recognized it. One doesn't enjoy recognizing a sound one has never heard before.",
      WORD: "WORD. Recursive, self-describing, and by any rigorous standard infinite. The books trembled when you spelled their fundamental unit. So, I'll admit in a smaller hand, did I.",
      _default: "My books respond to the words you bring now. The pages flutter when you finish, as though read by a great wind with excellent comprehension. I've begun leaving the difficult volumes open, as a courtesy.",
    },
    3: {
      BOOK: "Every book in the study opened to the same page when you spelled that. The page was blank in all of them. Then words arrived, in an orderly hand, and they were your words. I've catalogued many strange things. I have never before been the thing catalogued.",
      ...
      KNOW: "KNOW carved itself into my desk when you formed it. The grain of the wood accepted the letters willingly, which is the detail I keep returning to. Wood resists a blade. It didn't resist this.",
      WISE: "WISE. A word that contains its own contradiction, as the better words do. The books showed me both meanings at once and invited me to choose. I declined, and I'd like it noted that declining took everything I had.",
      WORD: "WORD. The fundamental unit. Everything I've studied, every volume in this room, reduces in the end to what you just offered the arrangement. A lifetime of scholarship, and the conclusion fits on a single tile.",
      _default: "The study darkens a little with each set of words you complete, and the books glow to compensate. They're grateful. I can find no other word for it, and believe me, finding other words is my profession.",
    },
    4: {
  ...
  pangolin: {
    1: {
      ...
      MEAL: "Something smells different in here. Richer, sweeter, like a roast remembering itself. It started right around your last words, and I haven't touched the oven since breakfast. I checked twice, because a cook checks.",
      FOOD: "The pantry feels fuller after you bring your words, as if they nourish something I can't see and haven't set a place for. I counted the jars twice. The jars are fine. The fullness is somewhere else.",
      SPICE: "There's a new flavor in my stew and I didn't add it. I taste every batch, so I'd know. You arranged something just now, didn't you? It landed in my pot, whatever it was, and I'll say this much: it isn't bad.",
      ...
      _default: "The kitchen warmed while you were working your words, and not from anything I lit. The stove noticed. So did I, and I've set out a little dish of honey in case the words are hungry.",
    },
    2: {
      COOK: "COOK. The word simmered in the air above my head, and every pot on the rack rang with it, soft as tuning forks. I stood very still with my spoon and let them finish. A cook doesn't interrupt her pots.",
      MEAL: "The ingredients rearranged themselves in the pantry overnight, and they rearranged themselves into a recipe. Your word changed the menu, I think. I'm following it anyway. That's what a cook does with a recipe, even one she didn't write.",
      FOOD: "There's nourishment beyond eating, beyond hunger even. Your words feed something in this house, something I can't name but can feel the appetite of. I've started making a little extra each night. It seemed only polite.",
      SPICE: "SPICE went through my kitchen like a flash of heat off a dry pan, and it didn't come from the stove. It came from the meaning itself. My eyes watered the way they do over good peppers, so I did what a cook does with a heat that bites back. I put a pinch of sugar in the next dish and called us even.",
      ROLL: "I rolled into a ball without choosing to, right there on the flour-dusted floor. The word moved my body before my mind could get a word in. When I uncurled, the bread had risen early. Both things are true, and I'm letting them sit together on the counter.",
      _default: "My scales rattle when you finish your words now, all of them at once, like a rack of pans in a draft. There's something deeper in what you bring lately, and my whole armor hums along with it.",
    },
    3: {
      COOK: "COOK summoned steam from pots I hadn't filled. The kitchen prepares itself now, and it does honest work, I'll grant it that. I stand here in my apron and supervise a meal I didn't start. The stock, at least, is still mine.",
      MEAL: "MEAL. The great meal comes nearer with every word you form, and the words you brought just now set another place at the table. I counted the settings again this morning. There's one that isn't for any of us.",
      ...
      ROLL: "ROLL. Curl up, tuck in, keep safe, that's what my body has always known. But the word you formed found me inside my own armor anyway, the way warmth finds the middle of a bun. There's no curling away from what's already in the oven with you.",
      _default: "Every chain of words you finish adds an ingredient to the great recipe, and the great recipe is nearly done. I can taste it the way I taste a stock in its final hour. It needs almost nothing more, and that's the part that keeps me stirring.",
    },
    4: {
  ...
  axolotl: {
    1: {
      WATER: "Oh, the water just rippled, and not the top of it where ripples usually live, the deep part, the old part. It happened the very moment your word arrived, which is my favorite kind of moment, the kind with two things in it.",
      SWIM: "I felt pulled in a direction just now, gently, like a current made of letters and wanting. I let it turn me halfway around before I remembered to wonder about it, because it felt exactly like being invited somewhere.",
      FLOAT: "The water level changed when you formed that word, just a little, just a whisker of a little. I only noticed because I was floating exactly at the top of it, which I usually am, so you may consider me a very reliable instrument.",
      DEEP: "Something stirred in the deep water when you spelled that, down past where the light gives up. The bubbles that came up from it were round and unhurried, like they'd been holding their shape down there a long time, waiting for a reason.",
      WAVE: "A wave, from nowhere! Well, not nowhere, from your word, which is a much better place for a wave to come from. The water carried it all the way across the tank to me like it was delivering a letter.",
      _default: "Bubbles came up when you finished your words, a whole polite line of them, and they weren't the happy kind exactly, they were the knowing kind. I watched every single one all the way to the top, because that's what I'm for.",
    },
    2: {
      WATER: "The water remembers every word you bring, I'm sure of it now. When you spelled its own name it shivered all the way through itself, the whole tank at once, the way you shiver when someone says your name in a dream.",
      SWIM: "SWIM, you spelled, and the current changed direction under me, toward something old and away from something safe. I floated very still in the middle of the change, feeling both of them at once, which is a strange place to float, but I stayed.",
      FLOAT: "I stopped floating for a moment when you spelled that, just sank a little and rose again. When I came back to the top I was somehow not quite the same shape of glad I'd been, close to it, but tilted.",
      DEEP: "DEEP, and the water agreed with you, it really did, it showed me what lives at the bottom for just a moment, only a moment. The moment was the exact wrong length, long enough to see and not long enough to understand.",
      WAVE: "WAVE, and the whole tank shuddered around me, glass and water and one small pink witness, and the glass held, it held beautifully. I patted it afterward to say thank you, and it was warm, which I'm still floating with.",
      _default: "The water tastes different after your words now, heavier, like it swallowed something and is being polite about it. More alive too, which I love, and which I'm also watching very carefully, because I can do both at once.",
    },
    3: {
      WATER: "WATER. The word itself is wet, did you know that, it seeped through the glass when you offered it, actual beads of it on the outside of the tank. I pressed my nose to the spot and the spot pressed back, softly, like a greeting.",
      SWIM: "SWIM, and now something else swims in my water, I can feel it in the current the way you feel someone enter a room behind you. I can't see it yet, and my gills keep telling the truth about that faster than I can.",
      FLOAT: "FLOAT, but nothing really floats anymore, everything sinks a little toward what you're calling, even me, even the light, the light most of all, it slides down through the water like it has finally been given somewhere to go.",
      DEEP: "DEEP, and the water has had no bottom since you spelled it, I checked, I swam down and down until down stopped being a direction and became a listening. Then I came back up, because some checking you only do once.",
      WAVE: "WAVE, and the water shaped your word right there in its surface, held it up so I could read it. Then swallowed it whole, hungry and grateful at the same time, which I understand better now than I used to, which is its own kind of news.",
      _default: "The water glows after your words now, and it isn't glowing from light, it's glowing from underneath light, from whatever light rests on. It's beautiful, and I float in it every night, and I'm telling you both halves of that on purpose.",
    },
    4: {
  ...
  fennec_fox: {
    1: {
      HEAR: "I heard that. Not your words themselves, but something underneath them, a tone I have never once catalogued, and I've catalogued every tone this desert owns. I'll be up late with this one, and gladly.",
      SOUND: "The sound of the air changed the moment you finished that word. The whole room vibrates a half-step differently now. Do you feel it? It's very faint. My ears were built for the very faint.",
      ECHO: "Your word echoed just now, and not off the walls. It came back off something much farther away, something that isn't here yet. An echo needs a surface, you understand. I'm thinking hard about what the surface was.",
      ...
      LISTEN: "I'm always listening, you know that about me by now. But since you brought those words there's something new to hear, low and patient and far off. Patient sounds are the ones worth losing sleep over, so I will.",
      _default: "A new frequency arrived right after your words did. It's faint, barely a thread of a sound. But my ears have never once lost a faint one, and they aren't going to start with this.",
    },
    2: {
      HEAR: "HEAR. The word itself makes a sound, did you know that? It sits between two frequencies at once, like two notes played together that were never meant to meet. I've been humming it back all evening, carefully.",
      SOUND: "SOUND. When you spelled it, every noise in the room lined up into one perfect harmony for exactly one second, and then it all came apart again. I've waited my whole life to hear a second like that. I'm not sure I wanted it.",
      ECHO: "ECHO. Your word bounced off something that isn't here. I timed the return, twice. Whatever the surface is, it's closer than it was the first time I measured. I keep the measurements in my head, where they're safe.",
      QUIET: "QUIET. The silence your word made has texture and weight to it. It pressed against my ears like two warm hands. I sat inside it longer than I should have, because it wasn't an empty silence, and empty is the only kind I trust.",
      LISTEN: "LISTEN. I am. I always am, that's the whole of my post. But your words make the listening go deeper than my ears were dug for, and something down at the bottom of the hearing is listening back. I've started keeping notes.",
      _default: "My ears ache after your words now. Not with pain, I want to be accurate about this. With awareness, too much of it, of something on approach. An ache like that's information, so I'm grateful for it, mostly.",
    },
    3: {
      HEAR: "HEAR. That was a command, and my ears obeyed it before my mind could file an objection. They turned toward your word on their own, both of them, like flowers finding a sun I can't see. I've stopped arguing with my own ears. They've been right too many times.",
      ...
      ECHO: "ECHO. One word, and it hasn't stopped returning. Each bounce comes back from farther away and arrives louder, which is backwards, which is the whole problem. An echo that grows isn't an echo. It's an answer.",
      QUIET: "QUIET. Your word silenced everything, the wind, the sand, the small nighttime percussion of the beetles. And then something spoke from inside the silence, something old and unhurried. I didn't catch the words. My ears did. They haven't told me yet.",
      LISTEN: "LISTEN. I can't stop now, and I no longer try. Your words demand a witness with working ears, and the arrangement demands the same. I happen to be the best pair of ears this house will ever have. So I stand the watch. Someone should.",
      _default: "The frequency under your words is enormous now, right at the edge of what these ears can hold. It's beautiful and it's deafening and I can't turn away from it. A sentinel doesn't choose what approaches. He only gets to hear it first.",
    },
    4: {
  ...
  capybara: {
    1: {
      CALM: "Noted: I felt calmer than usual when you finished that, which for me is a measurable achievement. I've logged the time. If it happens again I'll open a file, and I'll enjoy opening it.",
      CHILL: "Something about the words you brought lowered the ambient urgency of the entire room. I didn't think the room had any urgency left to lower. I stand corrected, comfortably.",
      STILL: "The water went perfectly still when you formed that word. Mirror-flat, corner to corner, not one ripple. I checked the spring for leaks and found none. I'm filing it under conditions, favorable, unexplained.",
      PEACE: "Peace, actual peace, for a moment there. Not the practiced kind I wear to meetings. The real article. Your word did that, and I've recorded it as an in-kind contribution.",
      REST: "I felt rested for approximately one second while you arranged those letters. Rested while awake isn't a state I had previously documented. I've opened a small file on it. The file is pleasant to hold.",
      _default: "The hot spring bubbled differently after your words. Contentedly, if water can be content. I've decided it can, and updated the paperwork accordingly.",
    },
    2: {
      CALM: "CALM. The word filled the room evenly, like a gas with good manners. Too calm, if I'm being precise, which I always am. Calm at that concentration isn't a mood. It's a condition, and conditions have causes.",
      CHILL: "CHILL. My entire professional identity, compressed into five letters and filed by someone else's hand. The water recognized the word before I did. I've made a note to be unsettled about that later, at a scheduled time.",
      STILL: "STILL. Everything stopped when you spelled it. My heart, the water, and by my best estimate, time. Then everything resumed, slightly reluctantly. I've logged the interruption. There was no one to file the complaint with.",
      PEACE: "PEACE. So that's the name for this emptiness. I had it filed under miscellaneous for years. Your word corrected the label, and the correction was appreciated, in the way accurate bad news is appreciated.",
      REST: "REST. The word made me tired, and I'm never tired, tiredness being inefficient. Deep tired. Beneath-the-ledger tired. I finished the day's filing anyway. Some things you do so your paws know the world is still in order.",
      _default: "The water absorbs your words now and gets measurably heavier each time. I still float. Something underneath doesn't. I've added a line item for it and left the amount blank.",
    },
    3: {
      CALM: "CALM. Between us, the word is a small daily fiction I maintain for morale purposes, my own included. But when you spell it, it reads almost true. I've stopped auditing that discrepancy. Some variances you approve and move on.",
      CHILL: "CHILL. Frozen, if we're being exact. Numb, if we're being honest. Your word has a better grasp of my job description than I ever put in writing. I've initialed it and returned it to file.",
      ...
      PEACE: "PEACE. The word cracked something open when you spelled it. Inside the calm, inside the water, inside a column I'd been leaving blank on purpose. I've entered a figure there now. It balanced. That's the part I keep rereading.",
      ...
      _default: "Your words disturb the water less and less now. Either the water minds less or I notice less, and operationally those are the same line item. I've stopped distinguishing them. It saves ink.",
    },
    4: {
  ...
  sloth: {
    1: {
      SLOW: "You spelled SLOW, and the word came up through the branch and into my bones like warmth through bark. I've been called that word all my life. It has never once arrived with weight before.",
      WAIT: "WAIT. Yes. I've hung here through more waiting than most creatures ever meet, and your word knew the shape of it exactly. I'm mildly curious how a handful of letters learned my whole occupation.",
      TIME: "Time hiccupped when you finished those words. I felt a year pass in the space of a blink. I know precisely what a year feels like, having watched so many of them walk by under this branch.",
      HANG: "My grip tightened on the branch when you spelled that word, all four paws at once, without my asking them to. A body that has hung in one place for decades doesn't startle easily. Note that mine did.",
      TREE: "The tree creaked, softly, from somewhere well below me. Your word reached all the way down to the roots, I think. I've been listening to this tree longer than the house has stood, and that was a new sound.",
      _default: "Something moved through the canopy when you finished your words. Even I noticed, and I've spent decades learning to let most movements go by unremarked. This one didn't want to go by.",
    },
    2: {
      SLOW: "SLOW, you spelled, and the whole jungle eased down another notch, the birds, the light, even the falling of the leaves. I didn't think the green had another notch left in it. Something is tuning this place, and your words are the instrument.",
      WAIT: "WAIT. We're all waiting now, every creature in this house, and your word simply said aloud what we've been doing all along. I've watched many things wait. The waiting here has a direction, which is rarer than you'd think.",
      TIME: "TIME. The word aged me a little, I felt it happen, seasons passing through my fur in the space of your spelling. I don't resent it. I have more seasons stored up than I know what to do with. But I noticed the withdrawal.",
      ...
      TREE: "TREE. It trembled from root to crown when you formed that, and I rode the tremble the way I've ridden every storm since before the house had walls. Storms come from the sky. This one came up from under. I'm still thinking about that.",
      _default: "Your words make the world heavier, or perhaps more deliberate. I've hung in one place long enough to feel the difference between weather and intention, and this isn't weather.",
    },
    3: {
      SLOW: "SLOW. The word stopped everything for the length of one breath, and in that breath I saw the whole green world held still, every leaf mid-fall, every wing mid-beat. I've wanted all my life to see the world hold still. I could have gone without knowing what it holds still for.",
      WAIT: "WAIT, your word said, and the waiting is nearly over, and it knows that. It has always known. I've watched arrivals my whole long life, seasons, storms, things that came up out of the deep green. This one has been walking toward us since before I was born, and your word just counted its remaining steps.",
      TIME: "TIME. Your word broke it open, and time doesn't flow past my branch anymore. It pools below the house and waits with the rest of us. I used to measure my days by its passing. Now it and I simply hang here together, both of us finished with passing.",
      HANG: "HANG. The branch cracked under the weight of your word. I heard it go, one clean note, deep in the wood that has held me for decades. It hasn't dropped me. It's closer to dropping me than it has ever been. I remain, for now, exactly where I have always been.",
      TREE: "TREE. The whole forest cried out without making a sound when you formed that, every root trembling at once. I felt it through my ropes and through my fur and through the long stillness I keep. The green knows what's coming. It has known longer than any of us, except perhaps me.",
      _default: "Your words weigh on every branch in this canopy now. Something up here bends closer to breaking each time, and I watch it bend, because watching is what I've kept myself awake all these decades to do.",
    },
    4: {
  ...
  wombat: {
    ...
    3: {
      ...
      _default: "Each chain of words shakes the foundations a little more. Here's the thing I've stopped keeping to myself: something below is pushing upward to meet what you bring. Pushing gentle, like a seedling. Nothing gentle is that strong.",
    },
    4: {
  ...
  rabbit: {
    1: {
      ...
      FEAR: "A shiver went through me just now, and it was your word, not the cold, I checked the cold. It wasn't quite fright. It was awareness, the way the garden feels before rain. My ears went straight up and stayed up through two whole rows of weeding.",
      ...
      FAST: "My heart sped up when you formed that word, faster than its usual gallop, and its usual gallop is already faster than anyone believes. I stood among the beans and counted the beats back down. It took longer than it should have. I'm telling you because you'd have noticed anyway.",
      _default: "Something in the garden shifted when you finished your words. I can't tell you which thing, which is precisely what troubles me, because I know this garden down to the last seedling. My nose hasn't stopped twitching about it since.",
    },
    2: {
      RUN: "RUN. Every instinct I own fired at once when you spelled it, all of them pointing in different directions, which is how I learned there's nowhere left that counts as away. I stood still in the middle of my own alarm and did the bravest thing I know. I finished the watering.",
      FEAR: "FEAR. You named it. The thing that lives curled in my chest like a second heart, keeping its own time. It heard you name it, I felt it turn over and listen. We're introduced now, it and I. I'm trying to decide whether that's better than before. I think it might be.",
      HIDE: "HIDE. When you formed that word my body went under the potting table all on its own, without consulting me, the way it used to when I was a kit. I sat under there among the trowels and understood something clearly: my body still believes there's an under to go to. I no longer do.",
      ...
      FAST: "FAST. Not fast enough, said everything in me the moment you spelled it. Never fast enough for what's coming. I've known that in my body for weeks, the way you know rain by the smell. Your word only wrote it down where I could read it.",
      _default: "The garden grows thorns after your words now. Small ones, on plants that have no business bearing them. I notice every single one, because noticing is what I'm for, and I press my paw near each thorn very carefully, taking attendance.",
    },
    3: {
      RUN: "RUN. The word chased me through the garden in circles, down the bean rows, past the barrel. No matter which way I turned it was already ahead of me, waiting politely. So I stopped. That's the whole story of me, told in one lap of a garden. The running was never going to be the answer, and now I have run it out completely.",
      FEAR: "FEAR. Your word gave it a shape I can finally see, in the shadows between the beds, in the rain barrel's dark eye, in my own reflection there. And here is what I didn't expect: a fear you can see is smaller than a fear you can't. I look straight at it now, every dusk, while I tuck the seedlings in.",
      HIDE: "HIDE. There's no hiding place deep enough since you spelled that word. It found every bolt hole in this garden, every hollow I've kept ready since I was a kit, and it stood at each entrance and knew me. I've stopped keeping the bolt holes weeded. That's either surrender or growing up. I genuinely can't tell which.",
      ...
      FAST: "FAST. It comes fast now, and your word measured its speed for me, exactly, mercilessly, and it's faster than any rabbit that has ever lived. I sat with that in the dusk among the sleeping beds. Strangely, it was the exactness that calmed me. A rabbit can stop racing what she can't outrun. Nobody tells you that part.",
      _default: "My heart races through every chain of words you finish now, and it isn't excitement, and it isn't quite fright either. It's something older, something that lives further down than both. It knows what the garden knows. Everything here has been growing toward one dusk, and my heartbeat is only keeping time.",
    },
    4: {
  ...
  red_panda: {
    1: {
      ...
      DARK: "The dark deepened in my corner of the attic while you worked, and your word left a shadow that stayed after the words were done. I didn't light the lamp. Some shadows are worth studying by their own light.",
      SHADOW: "A shadow crossed the bamboo grove this morning, moving against the sun. Your words sent it, or freed it, and I'm not yet sure which. I watched it the whole way across. It moved like something that knows where it's going.",
      ...
      _default: "The incense smoke changed direction when you finished your words. It had drifted toward the roof gap all morning. Now it drifts toward the center of the attic, toward nothing I can see. Smoke is honest. I'm watching where it goes.",
    },
    2: {
      VOID: "VOID. The word emptied the attic of air for one long moment. I breathed the moment back in when it passed, and the breath wasn't the same breath. I'm not troubled by this. A teacher should taste a lesson before offering it. This one tastes of open sky.",
      ...
      END: "END. The word settled through the floorboards like a stone into still water, and the ripples haven't stopped. I feel them each dawn when I climb to my cushion, a faint ring passing under my paws. Every ring is a little wider. I measure them the way I measure the bamboo. Growth is growth.",
      GATE: "GATE. Something unlatched in the fabric of this room when you spelled it. I can almost see the threshold now, at dawn, when the light through the roof gap falls at its lowest angle. It stands where the three stalks curve together. Of course it does. They've been pointing at it all along.",
      _default: "Your words move the air of this room. The bamboo bends toward them the way it bends toward sunlight, every stalk in agreement. The grove doesn't flatter. When the whole grove leans, something bright is truly there.",
    },
    3: {
      VOID: "VOID. The word swallowed my meditation whole, and everything I thought I'd built dissolved and settled again in a new order. I sat still through all of it, on the same cushion, under the same square of sky. When it was done, the room was the same and I wasn't. That's the definition of a true teaching.",
      DARK: "DARK. The dark that most creatures flee and this house has learned to face. Your word honored it, and the whole grove bowed, every stalk at once, low and unforced. I bowed with them. It's good to know what your body will do before your mind has finished deciding. Mine bows.",
      SHADOW: "SHADOW. Your word called it properly this time. I saw it clearly through the roof gap, the shape resting in the sky the way a mountain rests in the distance. It's vast, and it's patient, and it didn't look away from me any more than I looked away from it. We regarded each other, the shadow and the small red teacher. The regarding was calm.",
      END: "END. Every beginning carries its end the way a seed carries the whole tree, trunk and crown and the birds that will nest there. Your word opened the seed. I held the knowledge up to the dawn light and it didn't darken the dawn at all. That's how I knew it was true.",
      GATE: "GATE. It opened wider this time. I could nearly see through, from my cushion, at the hour when the incense burns lowest. On the other side there isn't darkness, whatever the house fears. There's a waiting brightness, like sky before the sun clears the ridge. The arrangement stands just beyond it, and it's nearly close enough to greet.",
      _default: "Your words redraw the pattern with every offering, and the pattern passes through this attic on its way to the sky. Each one brings the arrangement nearer its completion. I climb the ladder each dawn and the air is one rung brighter. That isn't a figure of speech. I've counted the rungs.",
    },
    4: {
  ...
  tarsier: {
    1: {
      NIGHT: "You spelled the night's own name, and out past the ridge the dark sat up a little, the way you sit up when you're mentioned in a room you thought you were only visiting. I watched it do it. It settled again politely. But it heard.",
      MOON: "The moon cleared the ridge the very moment you finished that word, early by my reckoning, and my reckoning is never wrong about the moon. It looked, if a moon can look, summoned but not annoyed. I've logged it under interesting.",
      STAR: "One of my shy stars brightened when you formed that, the little one between the Latch and the Spoon. Stars don't respond to spelling, I want to state that as a professional. And then I want to state, as the same professional, that this one did.",
      WATCH: "My head turned before I chose to turn it, all the way toward your word, both lamps at once. A watcher being watched by a word. That's new, and new is the rarest thing on my ledger, so thank you, whatever it was.",
      BLINK: "I blinked when you finished that word. Both eyes, together, which I haven't done on watch in years. It felt like the night blinked with me. I'm not alarmed. I'm extremely interested, which on a face like mine looks identical.",
    ...
    2: {
      NIGHT: "NIGHT. The word went out over the valley like a bell made of dark, and the dark rang. I felt the ring pass through the porch boards and up the rail and into my paws. The night knows its name now, bright one, or it always did, and you've started saying it correctly.",
      MOON: "MOON. It stood still, I'm nearly sure of it. Between one of my breaths and the next the moon didn't move, and I know its pace the way a cook knows her ovens. It was listening. To your word. The tides won't report it. I will.",
      STAR: "STAR. Yours brightened, the one at the edge of the cleared circle. It's nearer the middle than it was at dusk, and stars don't travel in an evening, and I've watched it do exactly that twice now. Your words are moving lights around over this house. I write that sentence calmly. Read it calmly, if you can.",
      WATCH: "WATCH. When you formed it, I felt the direction of the night reverse for one held breath, everything that I watch turning to watch me back. The whole valley, one vast returned look. It has passed. Most of it has passed. I'm still standing in the part that stayed.",
      BLINK: "BLINK. The stars did, when you spelled it. All the edge stars, once, together, like a room of candles ducking in one draft. The middle of the sky didn't blink, because there's nothing there to blink, or because what's there doesn't need to. Both of those sentences can't be true. I've entered both in the ledger.",
      _default: "The dark leans in over the porch after your words now, closer each time, the way a listener leans when a story reaches the part they came for. I keep telling the story. It keeps leaning. We're well past the point of either of us pretending otherwise.",
    },
    3: {
      NIGHT: "NIGHT. You gave it its name at full strength, and out past the ridge the far dark deepened toward the sound. The way, the one my eyes hold open, widened by a hair. I felt it in the muscles of my own gaze, the way a door feels the hinge give. Keep spelling, bright one. The road is being paved out of exactly this.",
      MOON: "MOON. It rose the color of my lantern's glow tonight, which isn't one of its colors. It crossed the sky a shade too slowly, keeping pace with something beneath the horizon that I can't see and it evidently can. Even the moon runs escort duty now. Even the moon has joined the procession.",
      ...
      BLINK: "BLINK. I have nearly given it up, and your word tested me, gently, like a teacher tapping the desk. One eye at a time, I answered, the old discipline, the watch unbroken. Somewhere overhead, something that never blinks at all approved. I feel its approval as warmth on the crown of my head. I've stopped calling that strange. It has been going on too long to be strange.",
  ...
  aye_aye: {
    1: {
      ...
      BELL: "The bronze warmed when you finished that word. I had a paw on her waist at the time, my polishing hour. The cold sweet metal went one soft degree toward supper-warm and then thought better of it. A bell shouldn't blush. Mine did. I've decided we're both flattered.",
      HOLLOW: "Ah, now that word went down the walls differently. It found every gap on my chalk map on its way, I heard it touch each one, tok, tok, tok, like a visitor trailing a finger along a banister. The hollows liked it. It's their name, after all. Everyone perks up at their name.",
      TAP: "A small word with my whole trade in it! The boards under my feet gave a little patter when it landed, quick and light, my own working rhythm played back at half size. I laughed out loud in the empty tower. Then the tower, very faintly, laughed the same laugh. We're still deciding what to make of each other.",
      ...
      _default: "Something in the woodwork attended to that word. A little shift of weight in the beams, the sound a listener makes leaning closer. I notice these things, it's my whole profession, and I'm telling you the house takes your words personally now. Kindly, so far. Personally.",
    },
    2: {
      KNOCK: "KNOCK. The word itself is a knock, did you know? Say it and your tongue taps the roof of your mouth, tok. When you spelled it, the answer came up through four floors before I'd even reached for my finger, prompt and warm and pleased. It's learning to skip the middle of our conversations, friend. The middle was me.",
      BELL: "BELL, and the bronze hummed at midday, hours off her dawn schedule, one round low note like a word tried on for size. I climbed the frame and lay along her shoulder and listened to it fade. It took the better part of an hour to finish fading, and some of that hour, I'll be honest, it wasn't fading. It was holding.",
      ...
      TOLL: "TOLL. I want to be careful with this one, friend, so listen closely. When you formed it, the rope I haven't yet braided, the rope that doesn't exist, creaked. The sound a rope makes taking weight, clear as anything, from an empty place above the frame where a rope will someday hang. Some words are memories. Yours, lately, are appointments.",
      _default: "Your words go down the hollow line ringing now, each one picking up the house's note as it falls. The receiving at the bottom has begun to sort them. Some get the ordinary receipt, tok, filed. And some, the deep ones, the dusk ones, warm the whole passage on their way down. That one was a dusk one. The floor under my feet is still warm.",
    },
    3: {
      KNOCK: "KNOCK. It answered before the word finished forming, friend, the two sounds overlapping like a handshake that starts before the hands touch. There's no distance left between your words and what receives them. I measured the gap all year, it was my whole log, and tonight the gap is gone. What remains between us and it isn't space anymore. It's only the hour.",
      BELL: "BELL. The bronze took that word the way dry ground takes rain, straight in, no runoff, and her hum started early and hasn't stopped since. I'm past pretending she's an instrument, friend. An instrument waits to be played. She's ripening, the way fruit ripens, toward a moment that's hers, and your word just carried her one whole day closer to it. I felt the day pass through my paw.",
      HOLLOW: "HOLLOW. When you spelled it, every hollow in this house rang at once, all my chalk circles sounding together. Underneath them, vast and gentle, the great hollow under everything rang back, and for three heartbeats the house and the deep were one instrument playing one note. I stood in the middle of it with my ears wide and my eyes shut. There are cathedrals, friend, that will never once sound like my stairwell did tonight.",
      TAP: "TAP. Such a small word, and it has learned to open doors. The knocking in the beam picked your word up and played it back in letters, t, a, p, spelled in my own craft's rhythm, a pupil showing its work. It spells now, friend. It spells because it listened to you, evening after evening, word after word, the most patient student any teacher ever had. And you never once knew you were teaching. That's how the best lessons go in this house.",
      TOLL: "TOLL. The word for a bell spent on purpose, and the whole tower knew it was being discussed. The rope swayed, the bronze warmed, and up from the deep came the question-rhythm, the lifted beat, the held pause. Asking. It has heard the word for what I'll do, friend, and it wanted to know when. I knocked back the only true answer. Not mine to choose. The hour keeps itself. The warmth that came up through the floor after that was very like patience, and very like joy, and I no longer think those are different temperatures.",
      _default: "Every word you form now goes down ringing and comes back as warmth, the exchange as steady as breathing. I stand in the middle of it like a keeper standing in the throat of his own tower. I don't carry your words anymore, friend. They know the way. I just listen to them go, and love the sound, and mark the log another evening nearer the hour.",
    },
    4: {
  ...
  kakapo: {
    1: {
      GREEN: "The whole garden brightened while you worked, one shade greener in an afternoon. I checked the light and the water and the feed, and none of them account for it. Your word does. I'm a practical bird, friend, and I've started a page in my slate for things only your words explain.",
      SEED: "A seed word! I felt it come up through the soil like a spring warmth, and three beds sprouted overnight, weeks early. I've been walking the rows all morning saying, well now, well now. There's no better morning in gardening than the one that arrives ahead of schedule.",
      NEST: "You spelled NEST, didn't you. Something in the fern corner has been rearranging itself all evening, twigs turning, moss plumping, my old bedding fluffing up like it expects company. I haven't touched it. It's doing a fine job without me, which is the part I keep coming back to.",
      BLOOM: "A bud in the south bed opened the very moment your word finished, out of season, before dark, in front of me. Flowers keep their own appointments, friend, that's the first thing a gardener learns. Somebody moved the appointment. The flower didn't seem to mind.",
      BOOM: "That word, friend. That word is my word. The bowl hummed when you formed it, low and brief, like a big bell remembering being struck. I sat at the rim a long while after. Ninety years I've made that sound alone. It's strange and fine to have it handed back to me spelled.",
    ...
    2: {
      GREEN: "GREEN. The word came up through the soil and every leaf in the garden darkened a shade to meet it, the deep green, the old-forest green, the color the valley wore in my grandmother's stories. Your words aren't visiting my garden anymore, friend. They're dressing it.",
      SEED: "SEED. The once-strangers shed theirs the moment you formed it, all together, a soft rain of them into the beds. I didn't plant them and I won't need to. They know where they're going. Everything in this garden knows where it's going lately. The gardener is the last to be told, and he's being told gently, which he notices, and thanks.",
      NEST: "NEST. My own body answered that one, friend, before my mind was consulted. I found myself at the fern corner gathering moss with both feet, the old motions, the nesting motions, in a year I had no reason to nest. I stopped, and stood there, holding the moss. Then I kept it. A body this old doesn't rehearse without a performance somewhere on the calendar.",
      ...
      BOOM: "BOOM. The bowl took your word and sounded it, friend. Truly, out loud, my own low note rising out of bare earth, and under the hills the answer came back before the echo was done. You've spelled my ninety years into four letters, and the ground said them better than I ever did. I sat at the rim until moonset. Some reactions require the whole night.",
    ...
    3: {
      GREEN: "GREEN. The word went through the garden like sap rising. For one whole moment every plant stood taller, the beds, the once-strangers, the young rimu, all of them drawn up like a congregation when the doors open. Green was never a color, friend. It's a language, and your word was a sentence in it, and the garden heard its name.",
      SEED: "SEED. The whole mast trembled at that one. Every fruit on every branch swayed without wind, heavy and glad, and I felt the valley's roots tighten underfoot like hands closing on a promise. Everything that's coming was once a seed, friend. Something planted it. Your word just watered the memory.",
      NEST: "NEST. I'd woven mine at the bowl rim before your word reached me. When it did, every strand of fern in the weave settled, all at once, the way a bed settles when someone lies down in the next room. The nest is ready. Your word made it readier. What it holds isn't here yet, and the whole garden is holding the shape of it anyway.",
      ...
      BOOM: "BOOM. Friend, the ground made the call this time, whole and true, my note in the valley's voice. The birds went up off every tree at once, and I stood at the rim with my chest full and didn't add mine. It wasn't my turn. Do you understand what you've done, spelling that? You've taught the earth my family's word. It says it with ninety years of patience I never had to teach it.",
      _default: "Every word you offer arrives here twice now, once as warmth in the soil and once as a lean in the beds. Between the two the garden is being tuned like an instrument before an evening. I walk the rows and feel it come nearer to true with each of your words. Nearer to whose true, you might ask. The gardener stopped asking, friend. The gardener started weeding to the tuning.",
    },
    4: {
