...
const TRIGGER_WORD_REACTIONS: Record<AnimalType, Record<number, Record<string, string>>> = {
  fox: {
    ...
    4: {
      FLAME: "FLAME. Every flame in the grate turned to face you at once, like a room full of guests. My fire's never had manners before. I didn't like it.",
      FIRE: "FIRE. I know how to keep a fire. I'm less sure what this one is keeping.",
      EMBER: "EMBER. The fire says my name back now, in a voice warmer than mine. I only answer to yours.",
      BURN: "BURN. I held a paw over the grate to test it. The fire pulled its heat back, the way a cat pulls in its claws. I don't understand a fire that won't burn.",
      ...
      _default: "Your word reached the fire and the fire took it. It still hasn't answered a single question of mine.",
    },
  },
  owl: {
    1: {
    ...
    4: {
      BOOK: "BOOK. I keep my plain notebook open beside the old book now. The two accounts don't agree.",
      READ: "READ. I wrote in the old book's margin that reading a thing isn't obeying it. This morning my note had been neatly erased. I've written it again, in ink.",
      KNOW: "KNOW. The old book has started finishing my sentences, with far more certainty than I ever had. So I've started ending mine with question marks. It doesn't know what to do with those.",
      WISE: "WISE. I'd settle for being willing to correct myself. That's harder, and worth more.",
      WORD: "WORD. Yours goes in the record, along with how and when you formed it. Never the word alone.",
      _default: "The old book wrote something new when you finished that word. It reads like a correction. I'll compare it with the original before I agree.",
    },
  },
  pangolin: {
    1: {
    ...
    4: {
      COOK: "COOK. I'm still the one who chooses what leaves this kitchen.",
      MEAL: "MEAL. Words feed something in this house. That doesn't make us the meal.",
      ...
      _default: "The pot answered when your word arrived. I'm keeping the lid within reach.",
    },
  },
  axolotl: {
    1: {
    ...
    4: {
      ...
      DEEP: "DEEP. I don't know everything that's underneath me. I can admit that now.",
      WAVE: "WAVE. I waved at the deep part, and it waved back before I'd finished, like it already knew how I wave. So I'm inventing a new wave.",
      _default: "The water heard your word. I'd like to hear what you meant by it too.",
    },
  },
  fennec_fox: {
    1: {
    ...
    4: {
      ...
      ECHO: "ECHO. I can repeat your word without pretending it's mine.",
      QUIET: "QUIET. The whole valley hushed when you said it. The crickets, the wind, the sand cooling. I used to ask for quiet. I've never been so frightened of getting it.",
      ...
      _default: "Your word made the sand shake. That's what I heard. What it means is a separate conversation.",
    },
  },
  capybara: {
    1: {
    ...
    4: {
      CALM: "CALM. That's a feeling each person reports for themselves. I won't enter it for you.",
      CHILL: "CHILL. That's my name, not an instruction.",
      STILL: "STILL. Every clock in the office now agrees to the second. They never agreed before. I've set mine four minutes fast, as a protest.",
      PEACE: "PEACE. I'll leave a space on the form for a different answer.",
      REST: "REST. My chair stopped squeaking overnight. I didn't oil it. Somebody fixed it while I slept, and I'd like my squeak back.",
  ...
  sloth: {
    ...
    4: {
      SLOW: "SLOW. I let that word sit in the hammock with me. For a moment I wanted everything to stay this slow forever. That wanting is the part of me I trust least.",
      WAIT: "WAIT. I've been good at that my whole life. Now something's waiting on us, and I don't enjoy it much from this side.",
      TIME: "TIME. I'd like another evening with you. I'm not asking for every evening.",
      HANG: "HANG. I've hung here a long time. It's a position I can choose to leave.",
      TREE: "TREE. I want this one to keep growing. Growing means it has to change.",
      _default: "The three Geralds woke at your word and settled again, all facing the same way. They've never once agreed on a direction. I turned the hammock so they'd argue.",
    },
  },
  wombat: {
    1: {
    ...
    4: {
      DIG: "DIG. I won't cut anything until we've decided what stays whole.",
      EARTH: "EARTH. The soil along the old seal has gone smooth as a plate. I scratched a line in it with my claw, for the record. By morning it'll be smoothed over. I'll scratch another.",
      DEEP: "DEEP. Deep doesn't mean safe. Those are two different measurements.",
      DARK: "DARK. The lamp's still a good idea. It was always a good idea.",
      ROCK: "ROCK. That's a fine stone. If we need a gap there, a fine stone still has to move.",
      _default: "The burrow wall creaked at that one. We still decide what gets built against it.",
    },
  },
  rabbit: {
    1: {
    ...
    4: {
      ...
      FEAR: "FEAR. Mine to understand. It isn't a fault for somebody else to repair.",
      HIDE: "HIDE. I'd like a private place. That's not the same as wanting to vanish.",
      JUMP: "JUMP. I still jump at things. I still spill the tea when I do.",
      FAST: "FAST. My seedlings came up in an hour, every one the same height, in straighter rows than I planted. I pulled one up to make a gap. I'm keeping the gap.",
  ...
  red_panda: {
    ...
    4: {
      ...
      DARK: "DARK. I don't know everything that's in it.",
      SHADOW: "SHADOW. I won't paint a kind face on it just to keep us calm.",
      END: "END. I used to tell everyone an ending was only a long rest. It was a lovely thing to say. It wasn't true.",
  ...
  tarsier: {
    ...
    4: {
      NIGHT: "NIGHT. The seam over the ridge brightened when you said it, and every moth on my rail turned to face it. I turned them back round. Moths aren't good at being told.",
      ...
      _default: "Your word went down and reached the edge. I'm watching the creatures on this side of it too.",
    },
  },
  aye_aye: {
    1: {
    ...
    4: {
      ...
      BELL: "BELL. I'm saving her voice for the moment we actually meet our guest.",
      ...
      TAP: "TAP. I can stop after this one knock. That's worth knowing.",
      TOLL: "TOLL. A word you formed is not an instruction to my hand.",
      _default: "The wood answered you. I'm listening for whether there's still room in these beams to disagree.",
    },
  },
  kakapo: {
    1: {
    ...
    4: {
      GREEN: "GREEN. I'd like this garden to keep growing in ways I didn't plan.",
      SEED: "SEED. There's still room here for something we haven't planted.",
      NEST: "NEST. I line mine and keep it ready. Whoever comes to it owes me nothing.",
      BLOOM: "BLOOM. The flower I never planted can keep the nick in its petal. I like it better that way.",
      BOOM: "BOOM. My call takes one great breath, and I'm saving it for when we meet. The calling bowl hums whenever you say that word. It's impatient. I'm not.",
      _default: "I've wanted an answer for ninety years. That doesn't mean I'll know it when it arrives.",
    },
  },
};
...
const SACRIFICE_REACTIONS: Record<string, { first: string; subsequent: string[] }> = {
  fox: {
    first: "The fire brightened when you set the amber down. That much I saw. It doesn't tell me why you gave it, and I won't guess.",
    subsequent: [
      "Thank you. Keep the next handful for something you want to build. The fire will manage.",
      "When your amber went down, the fire made the sound it makes when I say your name. I didn't teach it that.",
  ...
  pangolin: {
    ...
    subsequent: [
      "Your portion at supper isn't measured against what you give away.",
      "Your amber went down, and every pot in the kitchen came to the boil at once. I didn't ask for supper early. I turned them all off, one by one.",
      "You gave amber, and my pot stirred itself with nobody near it. It wants more. I'm not reaching for the rest of your amber, and neither is the pot.",
    ],
  },
  owl: {
    first: "I've recorded the amber you offered. The amount tells me what you gave. It doesn't tell me what it meant.",
    subsequent: [
      "Giving amber is evidence that you gave amber. It doesn't prove you agree with whatever the book says the gift means.",
      "A new page has appeared in the old book, describing your gift. If you tell me your reasons, I'll check whether the page kept those too.",
      "The old book has a new line of praise for you this morning, in very flattering ink. I've filed it under flattery, beside the other entries in that hand.",
    ],
  },
  axolotl: {
    ...
    subsequent: [
      ...
      "The water went warm and still after your amber, like a bath nobody gets out of. GLOW wouldn't swim. I splashed until he did.",
  ...
  fennec_fox: {
    ...
    subsequent: [
      "Your amber made a sound going down, and something below answered it, pleased. I went and listened to the crickets for a while. They weren't pleased about anything. It helped.",
      "The low note changed when your amber went in. I can't hear your reasons inside it.",
      "I heard you arrive before I heard the amber land. That first sound was welcome too.",
    ],
  },
  capybara: {
    first: "Your offering's recorded. The ledger added a line under it that I didn't write: gladly given. I've marked it unverified.",
    subsequent: [
      ...
      "A new form appeared on my desk after your offering. It has a box for your next gift, already filled in. I've torn the box off.",
    ],
  },
  sloth: {
    first: "You gave something, and the whole tree went warm. I enjoyed that far too much. Keep an eye on me when I enjoy things.",
    subsequent: [
      "I waited a long time. That doesn't entitle anyone here to your next offering.",
      ...
      "Keep something for yourself. An empty hand isn't the only proof that you care.",
    ],
  },
  wombat: {
    first: "I felt that go down through the foundation. A small load, and it gave a response I could measure.",
    subsequent: [
      "There's work your remaining amber could do. Hold on to it until you know what you want built.",
      "I can report what shifted down there. My gauge doesn't measure willingness.",
      "Your amber went down and my gauge twitched, then settled on a number I didn't set. I've written my own number beside it.",
    ],
  },
  rabbit: {
    first: "The amber caught the light as you set it down. I watched for a moment, then went back to my seeds.",
    subsequent: [
      "You're allowed to keep some things back. My tin is full of seeds that remind me of that.",
      "When your amber landed, every flower in the bed turned toward the house at once. Except the three I planted crooked. I'm so proud of those three.",
      "The flowers turned toward the warmth. I turned back to you, to ask if you would like some tea.",
    ],
  },
  red_panda: {
    first: "I watched you give the amber away. You can tell me what it meant to you, if you want. I won't guess.",
    subsequent: [
      ...
      "The smoke changed direction when you gave it. So the giving did something. I won't pretend it told me anything about you.",
    ],
  },
  tarsier: {
    first: "Your amber went down in a brief light. I saw where it went. I didn't see why you chose to give it.",
    subsequent: [
      "Your amber went down in a brief light, and for a moment every star over the ridge held perfectly still. I chalked the time. Chalk doesn't get excited.",
      "You may come up to the rail empty-handed. There is plenty to look at already.",
      "The light faded. I left the next line of my record blank. I'm not assuming another gift.",
    ],
  },
  aye_aye: {
  ...
  kakapo: {
    ...
    subsequent: [
      ...
      "A seed kept back for another season isn't a failed gift. You can keep some back too.",
    ],
  },
};
