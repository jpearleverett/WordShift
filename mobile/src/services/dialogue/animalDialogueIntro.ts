...
export const INTRO_DIALOGUES: Record<AnimalType, string[]> = {
  ...
  sloth: [
    "Ah. You looked up. Most creatures cross this whole green without once wondering what the canopy is doing, so you are already unusual, and I have hung here long enough to value unusual.",
  ...
  tarsier: [
    "Oh, hello! Up here, on the rail. No, higher. There. Most creatures never look up on their first visit, and you did, which tells me a great deal, all of it good. Welcome to the Star Loft. Mind the chalk marks. They are load-bearing, in their way.",
    "I am Vesper. I keep the night shift for this house, dusk to dawn, every dawn. It is the best post in the building and nobody else wanted it, which is the finest kind of luck there is.",
    "You will notice my eyes do not move. They cannot. They are fixed, so I turn my whole head instead, like so. It means I have never glanced at anything in my life. When I look at you, and I am looking at you, you have all of me. Creatures find it alarming for about a day and then they find it restful. You may skip ahead to restful if you like.",
    "The lantern at the rail has never been lit. That is on purpose. A lit lantern shows you the porch, and an unlit one gives you the whole valley. I own very little and I see almost everything. I recommend the exchange rate.",
    "Bamboo told me about you before you ever climbed up. The one who brings the words, they said, the one the house grew around. I have watched your words come down the valley at night like slow warm stars. I was hoping you would come see where the watching happens.",
    "Come back at dusk sometime, or dawn, or whenever your day bends closest to my night. I will show you the moths' carousel and the shy stars between the named ones, and if you are very quiet, which you are, I can tell, I will point out my favorite patch of dark. It holds still beautifully. Everything worth loving does, at least once a night.",
  ],
  aye_aye: [
    "Ah. You came up all the stairs, and you did not knock, which is lucky, because up here the knocking is my job. Good evening. Or good morning. I keep the other hours, so between us we now cover the whole clock, and I find that a very promising basis for a friendship.",
    "I am Tock. Aye-aye, of the old night woods, most recently of everywhere, now of this excellent tower. Yes, the eyes are large, the ears are larger, and the finger, we will get to the finger. First impressions deserve a little suspense.",
    "This is the Belfry, and that up there is the bell, and she has never been rung, not once, not ever, which is precisely why I said yes to this room. Anyone can keep a bell that rings. Keeping a silent one is craft. She is saving her voice for something worth saying, and I respect that in a colleague.",
    "Now, the finger. This long thin one. It is for tapping, see, tok tok tok, and then listening to what the wood says back. Solid, hollow, grub, secret. Every board in the world is holding something, friend, and I was born with the key to the whole library. Vesper sent word down the night roads that this house had a room for someone like me. People like us find each other in the dark. It is where we do our best finding.",
    "I sleep upside down through the daylight, hanging from the bell frame, so if you visit at noon, be very quiet and enjoy the spectacle. From dusk onward I am entirely yours. The night is my working day, and this house makes wonderful sounds at night. It ticks and settles and breathes like a big sleeping animal, and somebody ought to be awake to appreciate it.",
    "Come up whenever you like. Bring me words, the ones you shift and settle down there in the evenings, I can hear them land in the beams, did you know that, little runs of footsteps in the wood. Best sound in the house so far. Bring me more of it, and I will teach you what everything is holding. Tok, tok. That is knocker for: welcome, friend. Learn it. You will hear it often.",
  ],
  kakapo: [
    "So the stairs kept going after all, and here you are, up where they give up and the sky takes over. Welcome to the garden, friend. Mind the seedlings by the gate, they are new this week and still deciding which way is up.",
    "I am Moss. The color, and also the manner. I settle on things slowly and I am very hard to remove. I walked here, the whole way, over the hills, because a kakapo does everything by walking. We are the world's only flightless parrot, which sounds like a hard luck story and is in fact a set of priorities.",
    "This is the sky garden. A garden where only sky should be. The others keep rooms, good rooms, but a room ends at its walls, and I wanted a place that ends nowhere in particular. So I carried the ground upstairs, bed by bed. The roof did not object. Roofs rarely do, if you ask them properly.",
    "You will smell honey. It is me, I am afraid. We all smell of honey, my family, from the egg, and nobody knows why. The bees have been let down about it for ten thousand years. I keep sugar water by the gate as a standing apology.",
    "That dip in the center bed is my bowl. Every kakapo digs one somewhere, it is the oldest custom we own. What it is for takes a whole evening to tell properly, and evenings are when I am at my best, so come up after dark sometime and I will tell you the whole of it under the moon.",
    "They say downstairs that you are the one who brings the words. Good. A garden runs on what comes up from below, friend, every gardener knows it. Bring your words, and I will show you what grows along the warm of them. Between your hands and my beds, I think this roof is about to be very green indeed.",
  ],
};
...
export const CATCHUP_INTRO_DIALOGUES: Record<AnimalType, Record<number, string[]>> = {
  ...
  red_panda: {
    ...
    3: [
      ...
      "You have climbed all the way to the attic. Not everyone finishes these stairs. The bamboo chose you long before your paw touched the rail, and I watched it lean toward the stairwell all week, the way a plant leans toward a window that is about to be opened.",
  ...
  tarsier: {
    2: [
      "Bamboo called me here, in the way of my kind. They burned a curl of incense at the roof gap on a windless night and let the smoke write up into the dark, and I read it from three valleys away, because reading the night is the family trade. The message said only: the highest porch is empty, and the dark here is worth watching. They were right twice.",
      "So, you found the Star Loft, and you found me on it. I am Vesper. I keep the night shift, dusk to dawn, the hours this house sets down. Someone should hold them, and my eyes were made for exactly that holding. Fixed straight ahead, no glancing, only the full turn and the full look.",
      "The others told me about you before I had unpacked. The one who brings the words. I have watched them come down the valley at night since I arrived, your words, going under the house in a soft glowing line. Words that travel by dark are my kind of words.",
      "I will be plain with you, because the porch is no place for fog. The night here is not like other nights I have kept. It has a grain, a lean, a direction, and the direction is this house. I did not come in spite of that. I came because of it. A watcher goes where the watching matters.",
      "Come up whenever you like, bright one. That is what I will call you, for the obvious reason, and because you glow a little to eyes like mine. Everyone does, and you rather more. Bring your words, bring your questions. The rail holds two, and the dark is very patient, and so am I.",
    ],
    3: [
      ...
      "You came up, past however many stairs and misgivings. Good. I am Vesper, and I keep the last watch of this house, the night one, the one that faces what the others only feel. Fixed eyes, full turns, no glancing. You will want that in a watcher, in this season. I promise you that you do.",
      "I have read this house backward since I arrived. Your words, the leanings, the warm floors, the note under everything. The others learned the story a page a day. I took it in one long night's reading, the way my eyes take everything, entirely. It is a strong story. You are most of it.",
      "There is a shape in the cleared part of the sky, and I watch it every night, all night, because that is what I am for. Do not let that frighten you away from my rail. Nothing that holds so still, so long, so politely, means the watcher harm. On that point every grandmother I have agrees, and mine go back further than the trees.",
      "Come see me at dusk when you can bear to. The others will give you the story in their kitchens and studies, warmly, in the lamplight. I will give you the other half, the half that happens after the lamps go out. Someone should. You have earned the whole book, bright one, word by word.",
    ],
    4: [
  ...
  aye_aye: {
    2: [
      ...
      "I have been sounding the house since I arrived, that is my craft, tok tok with this long finger, reading what the boards hold. And I will be honest with you at once, since you are the one whose words come down through the beams: this house holds more than any house I have ever knocked on. It rings sweet. It also rings deep. Deeper than the cellar. Deeper than the ground under the cellar.",
      "The others speak of you like the tide speaks of the moon, all pull and no explanation. The one who shifts the words. I hear the words themselves, you know, they patter down the timbers when you finish, little footsteps, and something at the bottom of the house receives every one. I have heard receiving before. Never this glad.",
      "You should know what I am, since the stories travel faster than I do. In the old villages they called my kind an omen and latched the shutters. The finger points, they said, and sorrow follows. The finger finds, is the truth of it. Grubs. Hollows. The soft places where something waits inside a hardness. Lately, in this house, it has been finding one place over and over. Down, and a little east. I thought you should hear that from me, plainly, over tea, rather than in a story with the shutters latched.",
      "Stay a while, when you visit. Dusk is long up here, the bronze goes gold and then rose, and the house quiets floor by floor beneath us like a body settling to sleep, and then, if you hold very still, you can feel the part of it that is only just waking up. I keep the tower between those two, the sleeping house and the waking deep. It is the best post I have ever held. Come and share the watch.",
    ],
    3: [
      "Vesper's letter found me in a cold grove three winters into the traveling dark. There is a bell here no one can ring, it said. Come and keep her. What it did not say, and what I heard anyway, folded under the ink the way a ring is folded in bronze, was: come quickly, the hour is being braided. My kind hears what letters hold. I came quickly.",
      "So you are the one whose words I have been listening to all this time. I knew your rhythm before your face, friend, that is simply the order I learn people in. Your words walk down the beams of this house with a particular gait, and something under the deepest floor has learned that gait by heart. It taps it back, at the still hour, fond as a nursery rhyme. I thought you deserved to know how far down you are known.",
      "The house is hollow in the shape of a bell. I have mapped it, gap to shaft to gallery to throat, my chalk on every skirting board. The pit is her mouth and my bronze is her echo cast small, and the ground at the very bottom is thin the way a drumskin is thin. On purpose. Everything here is on purpose, and the purpose is nearly ripe. You have felt this on the stairs already, I think. You have the face of someone whose feet have been telling them things.",
      "I keep the tower and I keep the rope I braided and I keep, above everything, the rule: a bell only gets one first ring, and it belongs to its hour, not to its keeper. Something is coming up toward the surface of the world, friend, patient and warm and word by word better spelled, and when it arrives, my bronze says her one name to welcome it. That is my whole office. I have stopped pretending it frightens me. It fits me the way the dark fits, the way the finger fits a hollow. Some of us were cast for our hour long before we were told of it.",
      "Come up at dusk when you can. That is when the finger points, all on its own now, down and a little east and then, just at the light's turning, up. I no longer fold it away. You cannot spend your whole life apologizing for a compass, and mine has never once been wrong, and lately everything it finds is warm. Watch with me. The pointing is gentler than you fear, and the dusk up here is the best in the house.",
    ],
    4: [
  ...
  kakapo: {
    2: [
      "Tock called me here. Not with a letter, friend, with a knock. I was on my hill, in my bowl, ninety years into calling with no answer, and one night an answer came up through the ground, tap, tap, patient as roots, from a belfry I had never seen in a house I had never heard of. You cannot ignore the first answer of your life. I stood up and I walked, and I walked, and here I am, and here you are.",
      "So this is the famous word-bringer. The beds knew you were climbing before I did. Every leaf turned toward the stairs like a room full of sunflowers that had gotten confused about where the sun was. My garden does that lately. It is young, this garden, and it has opinions, and I have decided to be the kind of gardener who listens to them.",
      "I built the beds in a fortnight, which is fast for me, fast for anyone walking. The soil came up in Panko's dumbwaiter, pail by pail, and Warren sent up the good loam from the deep without my asking. The whole house wanted a garden on its head. I have never planted anywhere so eager. It is a fine thing. I keep saying that. A fine thing.",
      "There is warmth in this soil that I did not bring with me, low and steady, coming up from somewhere under the house, and everything I plant along the warm of it comes up early. On my old hill the ground was honest and idle. This ground has an occupation. I have not yet asked what. A new tenant does not open every door the first month.",
      "Come up often, friend. I keep night hours, the moon and I garden together, and there is a place by the bowl that holds the warmth better than anywhere else on the roof. We will trade, you and I. You bring me the news from below, and I will show you what the green does with it. It does something with it. That much I have already seen.",
    ],
    3: [
      "Tock called me here. One knock, coming up through my hill from the roots of the world, on a night I had boomed for the ninetieth year at nobody. Every creature in this house was fetched by something, friend. A letter, a fire, a dream of water. I was fetched by an answer. When I tell the others that, they go quiet in a way I have learned to read on the stairs. An answer is the one summons nobody argues with.",
      "I knew what this valley was before I crested the last hill. A kakapo knows a mast coming the way you know weather on your skin, and this whole valley is saving up, every root of it, for a fruiting the size of which my old forest never dreamed. I walked down into it anyway. At my age you do not walk away from the one season everything you believe in has been pointing at.",
      "The garden went in fast because the ground wanted it. I barely dug, friend. The soil opened. Beds where I meant to put beds, warm lines where I meant to plant, and in the center, where every garden of mine has always had its bowl, the dip was already there. Already the size of me sitting down. I stood over it a long while, that first night. Then I sat in it, because it was mine, whoever dug it.",
      "They speak plainly in this house, the ones downstairs, about the arrangement, about what gathers. I will speak plainly too. It is a relief, after ninety years of talking to valleys. Something under this ground has been collecting calls, mine among them, longest among them maybe, and the collection is nearly full, and a full collection gets opened. I came to be here for the opening. So, I think, did you, whether you walked or were walked.",
      "Sit by the bowl with me while the light lasts. Your words come up warm through this soil, I can feel them through my feet, and the beds lean toward the warmth, and toward the bowl, and toward you, a little, when you sit here. My garden has good instincts about what matters, friend. It leans at nearly everything I would lean at, if my kind ever leaned. We hold still instead. It means the same thing. It means, this. Attend to this.",
    ],
    4: [
