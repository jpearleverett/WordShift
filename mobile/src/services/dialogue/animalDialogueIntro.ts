...
export const INTRO_DIALOGUES: Record<AnimalType, string[]> = {
  ...
  axolotl: [
    "Oh! Hello! A bubble popped and there you were. That is the best thing a bubble has ever done.",
    "I'm Axel. I decided the tank belonged beside the window, then remembered I can't move the tank. Somebody else did the lifting, so I'm taking half the credit.",
  ...
  wombat: [
    "Mind your head, that lintel is low. I measured the doorway for myself. Quickest way for a fellow to learn how tall everyone else is.",
    "Warren. Thirty years digging, seventeen chambers in that time. This burrow is my latest job, and I'm proud of the corners.",
    "That old foundation was down here long before anything was added on top. Good stone. I'll show you where my new work joins onto it.",
    "Everything I make comes out square. My corners, my shelves, and what I leave behind. It's a gift, but it's a hard one to mention politely.",
  ...
  kakapo: [
    ...
    "That shallow bowl in the dirt is where I make my call. I've sent it out for ninety years, then listened for an answer.",
    ...
    "This is a rimu seedling. It needs years to become a tree, and it needs water today. You can help with the part that fits in today.",
  ],
};
...
export const POST_REVELATION_DIALOGUES: Record<AnimalType, string[]> = {
  ...
  fennec_fox: [
    ...
    "The gecko taps seven times before deciding against something. I have deep professional respect for that.",
    ...
    "Your last word had an ending. I listened all the way to that ending, as carefully as I listened to the note your word let through.",
    "A beetle was knocking sand against my bowl. A small musician with no interest in an audience.",
    "My chart still has gaps in it. They stay blank until I hear something worth writing there.",
    "Some days I like the quiet. On the other days I do not owe it anything.",
    ...
    "The kettle needs a new lid. I had grown used to the rattle. Familiar is not always worth keeping at that volume.",
    "I stopped listening for a whole minute. Nothing asked me to apologize for it. Next I will try two minutes.",
    "Some sounds still frighten me. I can tell you which ones without telling you how to feel about them.",
  ...
  wombat: [
    "The weight on this house changed at midnight. Everything held. Now I look for the joints that held too tight, because those are the ones that crack.",
    "Old stone below, new timber above. Both go in the account of what holds this house up.",
    "I kept the revised measurements, not just the first ones. A job that came out well does not prove the first plan was right.",
    "My shovel handle is rough again, the way I like it. Splintered my thumb this morning. A familiar problem. I will take it.",
    "Somebody drew a limit for this house. I build to that line, not an inch past it.",
    ...
    "Something tidied my rubble pile. I sorted it back by the cut each piece came from. Tidy looks better and tells you nothing.",
    "I understand the seal better now. That does not mean I understood it back when I laid the brace.",
    "There is work I will not do, no matter how neatly the plan describes it.",
    "I liked being needed. That is how a bad instruction starts sounding reasonable.",
    "The wall holds. Whether it ought to be there is still argued. I keep two reports, what it bears and what it should.",
    "I took an afternoon off. The house did not fall down. Mildly insulting.",
    "If a room wants changing, bring me a drawing. We have not used up all the possible houses yet.",
...
export const CATCHUP_INTRO_DIALOGUES: Record<AnimalType, Record<number, string[]>> = {
  ...
  axolotl: {
    2: [
      ...
      "Sometimes the current carries letters. I've put a pebble where I first saw them.",
      "Sit by the glass sometime? You can tell me whether those same words have turned up anywhere else.",
    ],
    3: [
    ...
    4: [
      ...
      "This is more than ordinary water. I know that much. I do not know what the water can keep without changing it.",
      "The fish have their own particular habits. I watch the fish more closely than the reflections now.",
  ...
  wombat: {
    2: [
      "Warren. Mind the lintel, it's low. This burrow is new. The stone foundation under it isn't.",
      "Thirty years of digging before this job. I brought the tools that have worn to fit my hands.",
      "The old plans show joints down here. They're the sort I'd use myself to hold a weight up.",
      "Some grooves keep going behind those joints. I'll need a lamp down here before I try to explain them.",
    ...
    3: [
      ...
      "The rooms you've added are real weight. I can see them sitting on my gauge down here.",
      "We'll inspect the old stone and my new timber separately, so we know which is which.",
    ],
    4: [
      "Warren. I know how a structure holds together. I am still learning what this one was built for.",
      "The old foundation was here first. The rooms you helped add came long after it.",
      "Good workmanship does not make the orders behind it good. The joints here are excellent. That proves nothing else.",
      "If this household needs a limit, I want it measured and built out in the open, where everyone can see it.",
  ...
  kakapo: {
    2: [
      ...
      "That shallow bowl is where I make my call. Ninety years of calling, and listening afterwards.",
      "Here, when I hum while I work, something low hums back.",
      "I'd like that low sound to be the answer I've waited for. That's exactly why I keep checking.",
    ...
    3: [
      ...
      "A sound that only resembles an answer has cheered me more than it should. I'm aware of that.",
    ...
    4: [
      ...
      "Some seeds stay in the dry tin. There should be room for weather we have not met yet.",
