...
export const POST_REVELATION_DIALOGUES: Record<AnimalType, string[]> = {
  fox: [
    ...
    "I keep expecting the fire to explain itself. It's very good at being warm instead.",
    ...
    "I asked Panko whether she trusted me. She handed me a knife and watched me chop. We're starting with onions.",
    "The extra cup is back on the shelf. I'll take it down when somebody asks for it.",
    "Something is still down there in the warmth. I don't know how much of us it hears. So now I ask you things, instead of answering for you.",
    "My joke about the robes wasn't funny. I'm glad somebody finally said so.",
    "The fire and I are still writing to each other, in a way. I read its letters the way I'd read one from anybody who lied to me once. Slowly, twice, and out loud.",
    "My tail wore one side of the cushion thin. I turned it over, then turned it back. The worn side fits me better.",
    "You drew a line around the invitation, and it's holding. I want to keep noticing that line, especially when forgetting it would be easier for me.",
    "I'd like it to be easy between us again. I'm not going to hurry it. Hurrying the easy part is how I got us here.",
    "The chestnuts burned. I laughed, then I cried. Now the room smells appalling. Open the window, will you?",
    "The house still tidies while I sleep. Last night it straightened the kettle lid again. I knocked it crooked at breakfast. We've been at this for a week, and neither of us is winning.",
    "Thyme brought flowers and stayed by the door the whole time. I'm glad she came. I'm trying to let that be enough.",
    ...
    "The kettle's on because I wanted tea. There's enough for you, if you'd like some.",
  ],
  pangolin: [
    "Breakfast was late this morning, after that long midnight. Nobody died waiting for toast. I'm calling it a successful service.",
    "My grandmother's spoon still has its split, and it still catches my thumb. I could sand it smooth. Today I don't want to.",
    "The pot still gives the same perfect broth every day, with no help from me. I put too much pepper in mine. We survived.",
    "Ember still comes to chop onions. Yesterday we talked about something besides onions, for almost a minute. It's a start.",
    "There are two chalkboards in my kitchen now. One says what I'm cooking. The other says what people actually asked for.",
    ...
    "I used to call the whole house my table. I've stopped. It's a lot of rooms, and the things inside them belong to other people.",
    "Something listens at supper now. I don't give it a portion that belongs to somebody else.",
    "Archimedes dislikes my soup. He's wrong, and he's written it neatly in his notebook, so the mistake is well preserved.",
    "I cut up the ceremonial cloth and made an oven mitt out of it. Finally, a job I understand.",
    "The recipe that finished itself is still wrapped in its cloth at the back of the drawer. I haven't burned it, and I haven't cooked it. Tonight we're having my grandmother's barley soup.",
    ...
    "This loaf has a crooked seam down one side. Leave it be. That's where it tears open easily.",
    "I'm proud of this kitchen. I'm still working out how proud to be of its cook.",
    "Hungry? It's a plain question. You can give me a plain no.",
  ],
  owl: [
    "My account starts at midnight. After that, the seam in the sky closed, and the presence stayed. I've written those down as two separate facts. One doesn't explain the other.",
    ...
    "I was fond of you before I understood what your words were feeding. That part was mine. So was my poor judgment.",
    ...
    "The boundary we made belongs in the record. I don't have a proper heading for it yet, so I wrote it down without one.",
    "I've asked Panko to write her notes in the margins of a cookbook. My scholarly reputation may not survive it.",
    "I still file by affection. A catalogue is allowed to be personal, so long as it says so.",
    "Some mornings I miss being certain. I'm trying not to mistake that feeling for evidence.",
    "Thyme's ruler sits on the desk beside mine. We disagree about where to start measuring. Both of our marks stay on the page.",
    "I can't explain everything that stayed after the sky closed. I can show you exactly what changed on this page.",
    ...
    "The cover is wearing through at the hinge. I mend it myself. I won't ask this house for a book with a newer past.",
    ...
    "I've saved a question for tomorrow. I'm leaving it there until then.",
  ],
  axolotl: [
    ...
    "I don't have one answer about PLUM. I have the list instead, with his teeth marks on it. It keeps getting longer, and that seems right.",
    ...
    "My bubble game has no way to win. You'd be good at it. Or terrible. There's no way to tell.",
    "I laughed today and somebody looked worried. Something was funny, that's all. Laughing can happen after things hurt.",
    ...
    "My new toe isn't new anymore. It's lovely to be bored by a toe.",
    "Some days I can talk about the fish. Some days I'd rather hear about your day instead.",
    "Midnight kept a lot of things exactly as they were. I'd still like to be a little different by your next visit. Taller, maybe. Or better at squares.",
    "I put a rock somewhere inconvenient. Then I moved it, because it annoyed me. An excellent afternoon.",
    "The last A I scratched into the glass is still there. It doesn't have to be a lesson. It's a small crooked A, and it's mine.",
    "Don't finish a happy sentence for me. I might be taking it somewhere else.",
    "I can be relieved and still have questions. There's room for both in this tank. They do splash.",
    "Water remembers shapes. I remember interruptions. PLUM had a marvelous talent for interrupting me.",
    "Fennick can hear me laugh from his room. I asked whether he can hear me being quiet. Apparently I'm bad at that too.",
    "I haven't solved the feeling. I've cleaned the lamp. One job done.",
    "When I'm sad, the water warms up around me, trying to help. I thank it and swim to the cold end. Some feelings need their own temperature.",
    "Come and see the bubbles whenever you feel like it. I might have thought of something new by then.",
  ],
  capybara: [
    "Midnight ended. There was a day after it, so I dated the next sheet. Best paperwork I've ever done.",
    "My record of what happened has disagreements in it. That doesn't spoil a record. It makes it accurate.",
    "Good chair. Same squeak. The house offered me a quiet one again. I declined again.",
    "The house left a tidier copy of my notes on the desk. I'm checking it against the messy original before I file it. Tidier isn't the same as true.",
    "We agreed on a boundary. I don't get to change it just because it'd make my forms simpler.",
    "I made too much coffee. That's an observation. It doesn't mean you have to stay.",
    "I asked Thyme what help she actually wanted. She gave me a real job to do. Much better than telling her to relax.",
    "Some mornings I write down that I'm afraid. Some mornings I don't need to. I check the page at noon. So far it says whatever I wrote.",
    "My pen sat uncapped all afternoon. Nobody came along and capped it. Small victory, one ink stain on the carpet.",
    "There's no meeting today. You're welcome to attend anyway.",
    "I do like things in order. Now I check whether somebody was left out to make them look that way.",
    "My first report on all this was wrong. I kept it in the file. Next time I'd like to know that mistake on sight.",
    "Someone complained today and had no fix to offer. I accepted the complaint. Finding the fix isn't the complainer's job.",
    "I took a break in the hot spring and left the ledger here in the office. The two of us don't need to soak together.",
    "I'd like all of this settled. But I've stopped writing settled in other people's columns.",
    "Panko and I are speaking again. She reads the whole agenda every morning now and corrects my spelling in red. I've never been so glad to be corrected.",
    "I signed, then changed my mind. So I crossed the answer out and put my initials beside it. You can still read both.",
    "It still sits in on things. Some evenings the office goes warm and quiet, like someone's pulled up a chair to listen. I let it listen. I don't let it take the minutes.",
    ...
    "You're here. How you feel about that is your entry to write, not mine.",
  ],
  fennec_fox: [
    ...
    "I don't want a silence so complete that I couldn't hear someone ask me to stop.",
    "Wool over one ear, the other still turned toward camp. I'm learning to rest by halves.",
    "Axel laughed at a joke I missed. He explained it, which made it less funny. I'm glad to miss something ordinary.",
    ...
    "Some days I like the quiet. Other days I don't owe it anything.",
    "Someone answered me before I'd finished asking. So I asked again, from the beginning.",
    ...
    "The kettle needs a new lid. I'd gotten used to the rattle. Getting used to a noise isn't the same as wanting it that loud.",
    "I stopped listening for a whole minute. Nothing asked me to apologize for it. Next I'll try two minutes.",
    ...
    "I'd like another song with Vesper. One that neither of us knows yet.",
    "There's a quiet place behind the canvas. I've put down a second mat there, for you.",
  ],
  sloth: [
    "I got what I waited for. I'm still working out how much of that is good news.",
    "My moths slept through the arrival. All three are named Gerald, and all three missed it. They had their own night.",
    "Our guest lives in my tree now. When I hum, it hums along, half a beat behind me. I've started humming badly on purpose.",
    "Some nights the house still pulls my hammock tight. Every morning I loosen it again. We have a routine now. It's the most regular thing I've ever done.",
    "Some days I'm glad it came. I know that's a hard thing for the others to hear.",
    "Thyme disagrees with me about all of it. We can sit in the same shade while she does.",
    "I waited most of my life for this. Now the mornings are full of small jobs, and I didn't expect that.",
    "I wanted it here. I'm also glad it didn't get everything it wanted. Your last word gave it a limit. I'd never have thought to set one.",
    "I climbed down and fetched my own dumplings. Panko says her pulley has earned a holiday.",
    "Don't let my long life win an argument for me. I've just had more years to practice being wrong.",
    "Fennick asked whether I was ever frightened in all my years of waiting. So I told him about my bad night, all of it, at my own pace. He listened to the very end without once finishing my sentences. For Fennick, that's devotion.",
    "I tried apologizing quickly. That was new. I had to start over and do it at my own speed.",
    "The green grows while I sleep. I'm learning to stop supervising it in my dreams.",
    "You may dislike what I chose. I'd rather hear that than sit beside an easier version of you.",
    "Some afternoons the light sticks and won't move toward evening. So I climb down and walk once around the house, slowly. By the time I'm back, it's usually moved on. Usually.",
    "One of the moths has moved out. Gerald, of course. The Geralds who stayed are taking it personally.",
    "I did nothing all afternoon, and I didn't call it a discipline. I recommend it.",
    "The warmth is still in the tree. I can be fond of it and still move to another branch.",
    "I've started a new list of things worth hurrying for. Two entries so far. Supper with the others. And telling someone they're wrong while it still matters.",
    "Stay an evening if you like. I won't ask that evening to become forever.",
  ],
  wombat: [
    ...
    "I wrote my brother the whole account this time. The arch, the seal, that midnight. He wrote back that he's coming anyway, with his own spade. Good. My work could use a second pair of eyes.",
    "I kept the revised measurements, not just the first ones. A job that came out well doesn't prove the first plan was right.",
    "My shovel handle is rough again, the way I like it. Got a splinter in my thumb this morning. Familiar problem, and I'll take it.",
    ...
    "The stone under my mug is still warm. It keeps the tea hot. I don't need a theory for that today.",
    ...
    "I understand that seal in the foundation better now. That doesn't mean I understood it when I laid the brace.",
    ...
    "I liked being needed. That's how a bad instruction starts sounding reasonable.",
    "The wall holds. We still argue about whether it should stand there at all. So I keep two reports, one for each question.",
    "I took an afternoon off. The house didn't fall down. Mildly insulting.",
    "If a room wants changing, bring me a drawing. There are more ways to build this house yet.",
    "It holds today. I'll check it again the moment anything changes.",
  ],
  rabbit: [
    ...
    "Something listens in the garden now. When I talk to the beans, the whole bed goes quiet to hear. So I tell the beans ordinary things. Weather. Slugs. It'll have to get used to slugs.",
    "Some seeds are still in the tin, unplanted. I like owning a future I haven't sorted into rows yet.",
    "I complained to Bamboo for a whole minute, and they didn't once answer me with the weather. That's progress, for both of us.",
    ...
    "One bed is crooked because I planted it crooked. I labeled it, so I'll remember I meant to.",
    "I sewed pockets into my robe. Deep ones. The seed tin fits in the left, and string in the right. It's starting to feel like my own coat.",
    "Ember comes down to the garden most evenings now. I still have questions, and she answers the ones she can. She's learning to bring time as well as tea.",
    "A beetle frightened me this morning. Then it ate a seedling. I crossed out frightened and wrote annoyed.",
    "Please don't praise me for standing in my own garden. Ask me what's growing instead.",
    ...
    "My old list holds wrong guesses and correct observations. It's all in my handwriting.",
    ...
    "Tea? You can say no. I like questions that have real answers.",
    "I'm angry that I was told I was only nervous. I can be angry and still enjoy my flowers.",
    "Warren asked me before he adjusted the gate latch. I didn't know how much I wanted to be asked.",
    "I don't know what next spring will bring. I'd like to keep it that way, so it can still surprise me.",
    "Would you hold this string while I measure? I'm laying out the new beds, some rows straight and some crooked. I've already decided which. The house can find out when they come up.",
  ],
  red_panda: [
    "The incense smoke curled this morning. I watched it and didn't decide what it meant.",
    "Thyme was upset when we sat together. I didn't ask her to be calmer for my sake.",
    "The loose reed rattled all through my meditation. I was annoyed. That's the whole report, no lesson attached.",
    "The presence comes up to the attic most evenings, the way warmth rises. It settles under the roof gap, where I used to sit. I don't bow to it. I don't leave, either. We're still working out the rest.",
    "The invitation has a boundary, and it applies to my curiosity too. I don't need to look inside everything.",
    "I can enjoy the warmth now without talking everyone else into feeling it. I'm still working on that.",
    ...
    "I said I didn't know. The room stayed standing. That was useful to learn.",
    "I still miss my old certainty sometimes. I put the kettle on and wait for the feeling to pass.",
    "Some evenings the warmth tries to finish my sentences for me, with smooth, kind endings. I stop, and finish them myself. Badly, but they're mine.",
    "Thyme asked why I'd been so certain. This time I answered about myself, not about what was coming.",
    "Archimedes' incense is nearly gone. Ordinary supplies run out. I'll ask him where he bought it.",
    "The gap in the roof shows less sky than I remembered. I'd been filling in the rest from memory.",
    "We can leave a disagreement unfinished and drink our tea while it's warm.",
    ...
    "Fennick climbed my stairs today, for the first time since that night. He still didn't stay for tea. He stayed long enough to say the hum is quieter up here. I wrote that down in his words, not mine.",
    "I'd rather be a useful companion than an impressive guide.",
    "Third Dawn has finished flowering. There's a new shoot at its foot, and the warmth keeps leaning over it, as if to keep it small. I water it anyway. I haven't named it yet. I want to meet it first.",
  ],
  tarsier: [
    "The opening above the ridge closed over. I still look at the spot where it was. Then I turn and write down what's here now.",
    "There's a page in my watch log marked off duty. I've started using it.",
    "Fennick suggested a song I don't know. I objected. Then I asked him to sing the first part again.",
    ...
    "We set a limit on the invitation. I can see past an edge. That doesn't make it mine to cross.",
    "A cloud covered my favorite star tonight. I let it go unwatched for a while.",
    "I wanted to see the answer. I didn't expect to spend an ordinary morning sitting beside it.",
    "Some nights I'm still afraid to look away. I tell Fennick when that happens.",
    ...
    "The beetle under my lantern has moved out. I don't know where. A private life, apparently.",
    "Bamboo and I ask each other how we slept again, at the dawn handover. Badly, usually, both of us. It's a better question than whether the gap held.",
    ...
    "I'd like tomorrow night to surprise me. Something small. I'm not greedy.",
    "Take the spare seat. We can watch the same sky and notice different things.",
  ],
  aye_aye: [
    "The bell's got a note in her bronze now. I don't need to ring her to prove it to every visitor.",
    "The little scratch near her rim is still fading. I asked the house, out loud, to leave it alone. It fades more slowly now. I'm choosing to call that listening.",
    "Everyone asks what she sounded like that night. I was standing right beside her, and I still can't describe it. I only know it sounded like an answer.",
    "I like being welcome here. I'm learning not to treat that welcome as a debt I owe.",
    "Tok, tok. That still means hello. Some of my vocabulary survived an eventful night.",
    "I catch myself listening at a closed door. Then I remember to knock and ask what's behind it.",
    "My gnawing block needs replacing. I've worn it down to nothing, which is reassuring. Not everything in this house refuses to change.",
    ...
    "My finger shook over an ordinary little repair, and I laughed at myself. All that grandeur hasn't improved my workmanship.",
    "The presence still answers in the beams. I don't know whether it understands why I sometimes stop tapping back.",
    "We gave our invitation a limit. When the knocking in the beams comes close to it, I listen hard.",
    ...
    "There's a grub in the bell frame again. Nothing that happened that night has changed its plans.",
    "I wanted something lonely to find a home. I still want that. But a home already has others living in it, and they count too.",
    "I've kept one loose peg. It makes a different note from the fitted ones. Pleasantly useless.",
    "No tour today, unless you'd like one. We can just sit here where the bell's shadow ends.",
    "I asked the beams for a little quiet, then waited to see whether I'd get it. I'm still learning how to ask.",
    "Come whenever you like. You don't need to bring a word. The stairs announce you, and I know your step.",
  ],
  kakapo: [
    "After the long midnight, I watered the seedlings. Nothing that happened has made them too important to need water.",
    "Getting an answer isn't the same as hearing the voice you hoped for. I'm learning to tell the two apart.",
    "My calling bowl has a little rain in it. Today I'm letting it be a puddle.",
    "The old call comes out of this body. So does the undignified noise I make getting off a bucket. Same bird, both times.",
    "I waited ninety years for an answer. Now I'd rather my days were about something besides the waiting.",
    ...
    "The last word you gave that night had an edge to it. I'm glad. Even a garden needs a place where the gardener stops digging.",
    "Thyme hasn't planted every seed she owns. I admire a gardener who keeps some back for weather she hasn't met yet.",
    "Some days I'm glad of the answer. Other days I miss the asking. Nobody warned me both would be true.",
    "The weed I let stay beside the path has flowered. That's a fine argument for leaving a plan unfinished.",
    "I hummed a different tune while I worked today. The seedlings offered no opinion on it.",
    "The ground still knows my grandmother's words. Some nights it offers them, very kindly. I thank it and don't ask for more. Being answered didn't give me her back.",
    "Some of the house wanted a welcome from me that night. I gave one answer, for myself. A few of them are still sore about it. I'd give the same answer again.",
    ...
    "I'd like to learn something that takes longer than an afternoon. Better bucket carpentry, perhaps.",
    "If the humming stops, it doesn't mean I've left the garden. Sometimes it only means I'm eating.",
    "A branch grew across the path, so I moved the path. The tree and I are both allowed to change.",
    "Stay and help me water, if you like. There's a small empty pot by the gate for whatever we haven't thought of yet.",
  ],
};
...
export const CATCHUP_INTRO_DIALOGUES: Record<AnimalType, Record<number, string[]>> = {
  ...
  pangolin: {
    ...
    4: [
      ...
      "There's bread. You can eat it and still not be convinced.",
    ],
  },
  owl: {
    2: [
    ...
    4: [
      "Archimedes. I've brought paper, pencils, and a reputation I'm still trying to deserve.",
      "The old book calls what's happening in this house preservation. I'd like it to say what that word means.",
      "On the book's diagram, being kept and being unable to change look the same. I can't tell them apart on paper.",
      "My account keeps the disagreements too, not just the conclusions.",
      "You can correct it. I won't call your version an error before I've heard it.",
    ],
  },
  axolotl: {
    2: [
    ...
    4: [
      ...
      "This is more than ordinary water. I know that much. I don't know if the things it keeps come back the same.",
      "The fish keep the same habits every day. I watch them more closely than I watch my own reflection now.",
      "I want good things to stay. I don't want that wish to be the only thing you know about me.",
  ...
  sloth: {
    ...
    4: [
      "Sloane. I'm willing, and I'm uncertain. You should know both before you take any advice from me.",
      "I wanted this. My wanting doesn't count as permission from anyone else.",
      "My three moths slept through this whole explanation. All named Gerald. Sensible editors, cutting the part nobody needed.",
      "I'd like the two of us to keep being able to disagree.",
      "You can end this conversation whenever you want. I'm happy to hear your answer another day.",
    ],
  },
  fennec_fox: {
    2: [
    ...
    4: [
      "Fennick. I can hear a great deal. I can't hear whether someone agreed, unless they say so out loud.",
      "The sound underneath the house is still there.",
      "I'm listening for what the sound still leaves room for. Wind, insects, someone disagreeing out loud.",
      "If I ask you to repeat an answer, I want your own words, not an echo of mine.",
      "There's a second mat at camp. You can sit on it and say nothing at all.",
    ],
  },
  capybara: {
    2: [
    ...
    4: [
      ...
      "The forms here want everyone marked content. They're very firm about it.",
      "I've left the status field blank until each person tells me how they are.",
      "I won't amend a boundary just to make a report simpler.",
  ...
  wombat: {
    ...
    4: [
      "Warren. I know how a structure holds together. I can't say yet what this one was built for.",
  ...
  rabbit: {
    ...
    4: [
      "I'm Thyme. This garden is mine to tend. I'm finding out what else here is mine to decide.",
      "There are seeds in this tin. I've planted some of them. The rest are waiting until I choose.",
      "I'd like to feel safe. If someone promises me that, I want to hear the exact terms first.",
      "If I disagree with you, it doesn't mean I failed to understand you.",
  ...
  aye_aye: {
    ...
    4: [
      "I'm Tock. This finger finds the hollow places. It doesn't decide who deserves to live in them.",
      "Other places drove me out for looking strange. That was wrong, and it stays wrong, whatever happens here.",
      "A guest can deserve to be heard and still have to learn our limits.",
      "The bell rope hangs within reach of my hand. Within reach isn't an instruction.",
  ...
  kakapo: {
    ...
    4: [
      "I'm Moss. An old caller with a garden and one difficult wish.",
      "I wanted an answer. I also wanted one particular voice I lost long ago. Those aren't the same wish.",
      "The seedlings are still new. I don't want them kept as seedlings forever.",
      "I keep some seeds back in the dry tin. There's weather coming that I haven't met yet, and I want something left to plant in it.",
