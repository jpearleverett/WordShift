...
export const TENDING_DIALOGUES: Record<AnimalType, string[]> = {
  ...
  owl: [
    ...
    "Another page in the plain notebook. Today it holds a disagreement about where the spoons go, still unresolved. Whoever reads this later deserves something other than prophecy.",
  ...
  sloth: [
    ...
    "You came back. I used to say things like that were bound to happen. You chose to come. Saying it that way still takes me practice.",
  ...
  fennec_fox: [
    ...
    "The low note has gone deeper. The chime outside answered it with a note it has never played before. I wrote that one down twice.",
  ...
  capybara: [
    "Your tending is entered in the ledger, with the amount, in my hand. What it buys is still an open question, so I have left that column open too.",
  ...
  rabbit: [
    ...
    "The garden went very still while I worked today, the way it does when it is listening. I planted the row crooked anyway. Nothing came to straighten it.",
    "The garden is still changing. This spring I planted something I have never grown before, and I do not know what it will look like. Would you like to find out with me?",
  ],
  red_panda: [
  ...
  kakapo: [
    ...
    "Something has come up in the empty pot by the gate. I did not plant it, and I cannot name it yet. I am letting it grow into whatever it turns out to be.",
  ],
};
