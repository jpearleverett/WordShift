...
export const TENDING_DIALOGUES: Record<AnimalType, string[]> = {
  fox: [
    ...
    "You came back. I'm glad you did. I won't turn that into a promise about the next time.",
    "I burned the toast watching the flames. If the fire has something to tell me, I hope it includes how to clean the pan.",
    "We can tend something without giving it all of ourselves. I'm still practicing that. Tea breaks help.",
  ],
  pangolin: [
    "I stirred the pot after your tending. It still needed salt. A house can be extraordinary without being much of a cook.",
    ...
    "The bowl filled itself again, so I put a lid on it. We have enough. A cook should know enough when she sees it.",
    "Your tending doesn't excuse you from lunch. It doesn't mean you have to eat my soufflé either. Hospitality runs both ways.",
    "I tried a new recipe. It failed beautifully. There's bread instead, and I get to try again.",
  ],
  owl: [
    "I wrote down your tending, then crossed out the conclusion I'd started to add. You can still read it under the line. I'd seen rather less than I thought.",
    "Another page in the plain notebook. Today it's a disagreement about where the spoons go, still unsettled. Whoever reads this later deserves spoons, not prophecy.",
    "I checked the old account against today's. Some of it had changed. A changed memory isn't automatically a corrected one.",
    "The boundary we drew at the end is an entry in the index now. I check that entry as carefully as I check the new pages.",
    "There's still room in the oldest book for a question. So I've stopped calling it the last book.",
  ],
  axolotl: [
    "The current changed after you tended. I watched a bubble miss its usual corner. A small surprise, and I liked it.",
    "The water's warm at both ends now. So I put a cool stone by the glass. Now I've got somewhere different to sit.",
    "I grew another little toe. I didn't name it after you. I thought you might like to keep your name for yourself.",
    "I told a story about PLUM and laughed at the ridiculous part. Afterwards the sad part was still there.",
    "The bubbles do something new when I move the pebble. Want to see? I can't promise which new thing.",
  ],
  sloth: [
    ...
    "The vines grew in closer. I loosened one off the hammock rope. Company's welcome, but it shouldn't make my furniture unusable.",
    "I still enjoy the warmth in the tree. Thyme still objects to it. We finished our tea anyway, both of us.",
    "You came back. I used to say things like that were bound to happen. Now I say you chose to come. I'm still practicing.",
  ...
  fennec_fox: [
    ...
    "The low note's gone deeper. The chime outside answered it with a note it's never played before. I wrote that one down twice.",
    "I took the wool off one ear for your visit. I'll put it back when you go. That's how I manage company now.",
    "Vesper and I sang our song again. This time I changed a note, and she followed me. Neither of us wrote it down.",
    "The thing that lives in the house now makes a sound I know. You make a sound I know too. I mean to keep hearing the difference.",
  ],
  capybara: [
    "I've entered your tending in the ledger, with the amount, in my own hand. What it buys is still an open question, so I've left that column open too.",
    "I added a column to the ledger for things we want to change. It's filling up faster than I expected.",
    "The office ran two degrees warmer after the tending. I noted it, and opened the window a crack, so the warmth has somewhere to go.",
  ...
  wombat: [
    ...
    "I measured again after the tending. I wrote down every difference, including the one I didn't like.",
    "The soil shifted. I left my marker exactly where it is, so I'll know if it shifts again.",
    "I repaired a support with a different joint than the old one. The old way doesn't own every good answer.",
  ...
  rabbit: [
    ...
    "A new flower opened in the bed. I don't know what it is, so I labeled it unknown. I don't have to decide today whether I love it.",
    "My heart fluttered today. So I checked the gate latch, found it sound, and went back to my seedlings.",
    "The garden went very still while I worked today, the way it does when it's listening. I planted the row crooked anyway. Nothing came to straighten it.",
    "The garden is still changing. This spring I planted something I've never grown before, and I don't know what it'll look like. Would you like to find out with me?",
  ],
  red_panda: [
    ...
    "Thyme disagreed with something I said. I wrote her words down beside mine, so I can't later remember it as an easier talk than it was.",
    "Tending is something we can do together. Our reasons for doing it don't have to match.",
  ],
  tarsier: [
    "The far ridge looks clearer since the tending. I wrote that down before I decided I understood why.",
    "There's always more to see. I took my break anyway. The sky managed without a witness for ten minutes.",
    "Fennick heard a note I couldn't place. So I asked him to lead our duet at the rail, and I followed. His ears taught me more than my eyes did.",
    "I keep one page for what I notice while I'm looking away from the presence. It's filling up with perfectly ordinary stars.",
    "I keep the watch today because I choose to. Ask me again tomorrow. I want that question to stay open.",
  ],
  aye_aye: [
    ...
    "You can come up without tending anything. Tok, tok still means hello. There aren't any conditions on that greeting.",
  ],
  kakapo: [
    ...
    "I saved seeds from the odd flower instead of planting them all. I'd like to watch it through another season first.",
    "Something has come up in the empty pot by the gate. I didn't plant it, and I can't name it yet. I'm letting it grow into whatever it turns out to be.",
  ],
};
