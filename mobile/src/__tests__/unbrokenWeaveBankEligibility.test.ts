...
const STANDARD_BANKS: StandardBankSpec[] = [
  ...
  { name: 'MEDIUM', bank: PUZZLE_BANK_MEDIUM, minEligible: 405 },
  // Measured 2026-07-14: 449 / 474 eligible.
  { name: 'MEDIUM_PLUS', bank: PUZZLE_BANK_MEDIUM_PLUS, minEligible: 400 },
  // Measured 2026-07-14: 325 / 438 eligible.
  { name: 'HARD', bank: PUZZLE_BANK_HARD, minEligible: 290 },
];
