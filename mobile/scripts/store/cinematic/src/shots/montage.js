...
const BOARDS = [
  ...
  { room: 'garden', who: 'thyme', words: ['GLOVES', 'LITTER'], letter: 0, slot: 0, rx: 0.71, wide: [-3.15, -0.4, 0, 1], tall: [1.7, -0.8, 0.45, -1] },
];
 ...
 * resident stands behind the right part of the rack, inside its width, lifted by the tall
 * `lift` so the muzzle clears the upper tray's rail (y 1040-1052 at 1080x1920) by about 100
 * px or more at the lowest point of the ear bob and the hops (measured: Fennick about 137,
 * Thyme about 108): a head that only just clears the rail reads as peering over it, eyes to
 * the lens. The lift is capped so the feet stay behind the rack at a hop's peak (Thyme's
 * first hop, 0.36, lands her feet about 20 px under the rail at lift 0.45; at 0.6 they
 * showed), and the heads stay inside x 96-918 (ear tips included) and under the caption
 * band (ear tips at y 557 or lower at the hop's peak).
 */
