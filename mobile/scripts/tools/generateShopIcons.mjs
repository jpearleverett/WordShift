...
// 58 icons at 192x192 (= 64dp at @3x) in five families, each drawn by its own
...
//   finishes.mjs    4 finish-led tile themes (sold on material) + 6 move sparks
...
import { draw as drawFinishes } from './shopIcons/finishes.mjs';
