...
- `SURFACE` tokens: panel/card/button radii (28/16/18), bevel depth 5, press travel 3, highlight/shade band alphas, section-label letterSpacing 1.2, modal choreography (`modalIn` spring {friction 7, tension 65} entrance, `modalOutMs` 120 fast exit), stagger interval. `getPressSpring(phase)` gives buttons the letter tiles' weight language (bright snaps, dark releases heavily).
