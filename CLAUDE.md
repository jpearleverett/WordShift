...
### Challenge Mode
Optional harder mode: difficulty-aware undo limit (EASY/MEDIUM=2, MEDIUM_PLUS/HARD=1), no hints, **no ✓/✗ slot previews** (hidden pre-launch — see Word Preview Mechanic; stuck detection and undo/restart recovery are preview-independent). 1.5x amber. Challenge completions count 2x toward phase progression.
